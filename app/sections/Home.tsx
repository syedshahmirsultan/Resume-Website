...
function Home() {
  return (
    <section className='h-[900px] scroll-smooth w-12/12  bg-cover bg-black/90 sec'>
            <div id="home" className=" py-[100px] lg:py-[100px] xl:py-[250px]  px-[80px] flex flex-col shrink-0 xl:flex-row mx-auto  justify-evenly items-center">
                {/*Name and Image*/}
