...
const Interests = () => {
  return (
    <section id="interests" className="mt-[200px] scroll-smooth sm:mt-[300px] md:mt-[600px] lg:mt-[-100px] xl:mt-[-100px] 2xl:mt-[-300px] text-left "><div>
      <div><h1 className="text-7xl align-left lg:align-center text-gray-600 font-semibold mt-[800px] text-center md:mt-[700px] lg:mt-[200px] mb-28">Interests</h1></div>
